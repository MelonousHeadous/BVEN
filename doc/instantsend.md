...
This mechanism has been integrated into Bitcore-Node-BitcoinVenezuela which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinvenezuelapay/insight-api-bitcoinvenezuela#web-socket-api](https://github.com/bitcoinvenezuelapay/insight-api-bitcoinvenezuela#web-socket-api)
* API: [https://github.com/bitcoinvenezuelapay/insight-api-bitcoinvenezuela#instantsend-transactions](https://github.com/bitcoinvenezuelapay/insight-api-bitcoinvenezuela#instantsend-transactions)
...
By default, the BitcoinVenezuela Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinVenezuela Core daemon:
