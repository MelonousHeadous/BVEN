...
This document provides guidelines for internationalization of the BitcoinVenezuela Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinvenezuela_en.ts` remains unchanged.
