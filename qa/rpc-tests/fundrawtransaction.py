...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcoinvenezuela address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitcoinvenezuela address" in e.error['message'])
