/* src/config/bitcoinvenezuela-config.h.  Generated from bitcoinvenezuela-config.h.in by configure.  */
/* src/config/bitcoinvenezuela-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BVEN_CONFIG_H

#define BVEN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitcoinVenezuela Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitcoinVenezuela Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitcoinvenezuelapay/bitcoinvenezuela/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinVenezuela Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinVenezuela Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinvenezuelacore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcoinvenezuela.org/"
