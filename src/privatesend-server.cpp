...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all BitcoinVenezuela related functionality
...
/*
    ...
    allow endless transaction that would bloat BitcoinVenezuela and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("bitcoinvenezuela-ps-server");
