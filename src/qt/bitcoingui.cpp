...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinVenezuela address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinvenezuela: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about BitcoinVenezuela Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinVenezuela addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinVenezuela addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinvenezuela: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BitcoinVenezuela command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinVenezuela network", "", count));
    } else {
...
{
    QString strTitle = tr("BitcoinVenezuela Core"); // default title
    ...
    // Append title to "BitcoinVenezuela Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
