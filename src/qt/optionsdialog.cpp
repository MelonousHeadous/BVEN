    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BVEN-light"), QVariant("light"));
    ui->theme->addItem(QString("BVEN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BVEN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BVEN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BVEN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BVEN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BVEN-traditional"), QVariant("trad"));
