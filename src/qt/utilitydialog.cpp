    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitcoinvenezuela-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitcoinVenezuela in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BVEN, 0.1 BVEN, 1 BVEN and 10 BVEN -- sort of like the paper money you use every day.</li> \
