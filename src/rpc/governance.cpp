...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in bitcoinvenezuela.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("bitcoinvenezuela.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "bitcoinvenezuela",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "bitcoinvenezuela",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "bitcoinvenezuela",               "gobject",                &gobject,                true,  {} },
    { "bitcoinvenezuela",               "voteraw",                &voteraw,                true,  {} },
