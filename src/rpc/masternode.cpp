...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_30000);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print BitcoinVenezuela address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitcoinvenezuela",               "masternode",             &masternode,             true,  {} },
    { "bitcoinvenezuela",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitcoinvenezuela",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitcoinvenezuela",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bitcoinvenezuela",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bitcoinvenezuela",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
