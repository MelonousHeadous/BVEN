...
2. run bitcoinvenezuelad with -printalert or -sendalert like this:
   /path/to/bitcoinvenezuelad -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitcoinvenezuela.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitcoinVenezuela Core:0.12.0.58/"));
