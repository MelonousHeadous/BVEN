...
//! Discourage users to set fees higher than this amount (in Cajetans) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in Cajetans)
...
/** Absolute maximum transaction fee (in Cajetans) used by wallet and mempool (rejects high fee in sendrawtransaction) */
